...
impl<'a, TS: KeycloakTokenSupplier> KeycloakRealmAdmin<'a, TS> {
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_delete_adminrealmsrealmattack_detectionbrute_forceusers>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmattack_detectionbrute_forceusersuserid>
    ///
    ...
    pub fn attack_detection_brute_force_users_with_user_id_get(
        ...
        self.admin
            .realm_attack_detection_brute_force_users_with_user_id_get(
                self.realm,
                user_id,
            )
    }
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_delete_adminrealmsrealmattack_detectionbrute_forceusersuserid>
    ///
    ...
    pub fn attack_detection_brute_force_users_with_user_id_delete(
        ...
        self.admin
            .realm_attack_detection_brute_force_users_with_user_id_delete(
                self.realm,
                user_id,
            )
    }
