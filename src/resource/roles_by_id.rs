...
impl<'a, TS: KeycloakTokenSupplier> KeycloakRealmAdmin<'a, TS> {
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmroles_by_idrole_id>
    ///
    ...
    pub fn roles_by_id_with_role_id_get(
        ...
        self.admin
            .realm_roles_by_id_with_role_id_get(
                self.realm,
                role_id,
            )
    }
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_put_adminrealmsrealmroles_by_idrole_id>
    ///
    ...
    pub fn roles_by_id_with_role_id_put(
        ...
        self.admin
            .realm_roles_by_id_with_role_id_put(
                self.realm,
                role_id,
                body,
            )
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_delete_adminrealmsrealmroles_by_idrole_id>
    ///
    ...
    pub fn roles_by_id_with_role_id_delete(
        ...
        self.admin
            .realm_roles_by_id_with_role_id_delete(
                self.realm,
                role_id,
            )
    }
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmroles_by_idrole_idcomposites>
    ///
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_post_adminrealmsrealmroles_by_idrole_idcomposites>
    ///
    ...
    pub fn roles_by_id_with_role_id_composites_post(
        ...
        self.admin
            .realm_roles_by_id_with_role_id_composites_post(
                self.realm,
                role_id,
                body,
            )
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_delete_adminrealmsrealmroles_by_idrole_idcomposites>
    ///
    ...
    pub fn roles_by_id_with_role_id_composites_delete(
        ...
        self.admin
            .realm_roles_by_id_with_role_id_composites_delete(
                self.realm,
                role_id,
                body,
            )
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmroles_by_idrole_idcompositesclientsclientuuid>
    ///
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmroles_by_idrole_idcompositesrealm>
    ///
    ...
    pub fn roles_by_id_with_role_id_composites_realm_get(
        ...
        self.admin
            .realm_roles_by_id_with_role_id_composites_realm_get(
                self.realm,
                role_id,
            )
    }
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmroles_by_idrole_idmanagementpermissions>
    ///
    ...
    pub fn roles_by_id_with_role_id_management_permissions_get(
        ...
        self.admin
            .realm_roles_by_id_with_role_id_management_permissions_get(
                self.realm,
                role_id,
            )
    }
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_put_adminrealmsrealmroles_by_idrole_idmanagementpermissions>
    ///
    ...
    pub fn roles_by_id_with_role_id_management_permissions_put(
        ...
        self.admin
            .realm_roles_by_id_with_role_id_management_permissions_put(
                self.realm,
                role_id,
                body,
            )
