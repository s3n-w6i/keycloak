...
impl<'a, TS: KeycloakTokenSupplier> KeycloakRealmAdmin<'a, TS> {
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_post_adminrealmsrealmidentity_providerimport_config>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstances>
    pub fn identity_provider_instances_get(
        &'a self,
    ) -> RealmIdentityProviderInstancesGet<'a, TS> {
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_post_adminrealmsrealmidentity_providerinstances>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstancesalias>
    pub fn identity_provider_instances_with_alias_get(
        ...
        self.admin
            .realm_identity_provider_instances_with_alias_get(
                self.realm,
                alias,
            )
    }
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_put_adminrealmsrealmidentity_providerinstancesalias>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_delete_adminrealmsrealmidentity_providerinstancesalias>
    pub fn identity_provider_instances_with_alias_delete(
        &'a self,
        alias: &'a str,
    ) -> impl Future<Output = Result<DefaultResponse, KeycloakError>> + use<'a, TS> {
        self.admin
            .realm_identity_provider_instances_with_alias_delete(
                self.realm,
                alias,
            )
    }
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstancesaliasexport>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstancesaliasmanagementpermissions>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_put_adminrealmsrealmidentity_providerinstancesaliasmanagementpermissions>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstancesaliasmapper_types>
    pub fn identity_provider_instances_with_alias_mapper_types_get(
        &'a self,
        alias: &'a str,
    ) -> impl Future<Output = Result<TypeMap<String, IdentityProviderMapperTypeRepresentation>, KeycloakError>> + use<'a, TS> {
        self.admin
            .realm_identity_provider_instances_with_alias_mapper_types_get(
                self.realm,
                alias,
            )
    }
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstancesaliasmappers>
    pub fn identity_provider_instances_with_alias_mappers_get(
        &'a self,
        alias: &'a str,
    ) -> impl Future<Output = Result<TypeVec<IdentityProviderMapperRepresentation>, KeycloakError>> + use<'a, TS> {
        self.admin
            .realm_identity_provider_instances_with_alias_mappers_get(
                self.realm,
                alias,
            )
    }
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_post_adminrealmsrealmidentity_providerinstancesaliasmappers>
    pub fn identity_provider_instances_with_alias_mappers_post(
        ...
        self.admin
            .realm_identity_provider_instances_with_alias_mappers_post(
                self.realm,
                alias,
                body,
            )
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstancesaliasmappersid>
    pub fn identity_provider_instances_with_alias_mappers_with_id_get(
        ...
        self.admin
            .realm_identity_provider_instances_with_alias_mappers_with_id_get(
                self.realm,
                alias,
                id,
            )
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_put_adminrealmsrealmidentity_providerinstancesaliasmappersid>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_delete_adminrealmsrealmidentity_providerinstancesaliasmappersid>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstancesaliasreload_keys>
    pub fn identity_provider_instances_with_alias_reload_keys_get(
        &'a self,
        alias: &'a str,
    ) -> impl Future<Output = Result<bool, KeycloakError>> + use<'a, TS> {
        self.admin
            .realm_identity_provider_instances_with_alias_reload_keys_get(
                self.realm,
                alias,
            )
    }
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.5/rest-api/index.html#_get_adminrealmsrealmidentity_providerprovidersprovider_id>
    pub fn identity_provider_providers_with_provider_id_get(
        &'a self,
        provider_id: &'a str,
    ) -> impl Future<Output = Result<IdentityProviderRepresentation, KeycloakError>> + use<'a, TS> {
        self.admin
            .realm_identity_provider_providers_with_provider_id_get(
                self.realm,
                provider_id,
            )
    }
