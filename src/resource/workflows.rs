...
impl<'a, TS: KeycloakTokenSupplier> KeycloakRealmAdmin<'a, TS> {
    ...
    pub fn workflows_migrate_post(
        &'a self,
    ) -> RealmWorkflowsMigratePost<'a, TS> {
        RealmWorkflowsMigratePost {
            realm_admin: self,
        }
    }
    ...
    pub fn workflows_scheduled_with_resource_id_get(
        ...
        self.admin
            .realm_workflows_scheduled_with_resource_id_get(
                self.realm,
                resource_id,
            )
    }
    ...
    pub fn workflows_with_id_get(
        &'a self,
        id: &'a str,
    ) -> RealmWorkflowsWithIdGet<'a, TS> {
    ...
    pub fn workflows_with_id_delete(
        ...
        self.admin
            .realm_workflows_with_id_delete(
                self.realm,
                id,
            )
    }
