...
pub struct AuthorizationDetailsJSONRepresentation {
    ...
    pub dynamic_scope_param_from_custom_data: Option<TypeString>,
    pub identifier: Option<TypeString>,
    pub locations: Option<TypeVec<String>>,
    pub privileges: Option<TypeVec<String>>,
    pub scope_name_from_custom_data: Option<TypeString>,
    #[serde(rename = "type")]
    pub type_: Option<TypeString>,
}
...
pub type MultivaluedHashMapStringComponentExportRepresentation = TypeMap<String, TypeVec<ComponentExportRepresentation>>;
